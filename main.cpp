...
int main(int argc,char* argv[])
{
	...
	// MNIST from http://yann.lecun.com/exdb/mnist/
 	...
 	ReadMNIST(NumberOfImages,length,train_x,"train-images.idx3-ubyte");
 	ReadMNIST_Label(NumberOfImages,train_label, "train-labels.idx1-ubyte");
	ReadMNIST(NumberOfImages/6,length,test_x,"t10k-images.idx3-ubyte");
	ReadMNIST_Label(NumberOfImages/6,test_label, "t10k-labels.idx1-ubyte");
